  ...
  return (
    <>
      <Link to={`/job-detail?vacancy-id=${data.id}`}>
        <button className="bg-white border p-5 md:mx-auto mx-5 md:w-[80%] rounded-lg md:flex items-center mb-7 hover:drop-shadow-xl transition duration-400">
          <div className="md:mr-10 flex justify-between items-center mb-4 md:mb-0">
            ...
            >
              <img
                src={data.isBookmarked ? saveFilled : save}
                alt=""
                className="ml-2 h-5"
              />
            </button>
          ...
          <div>
            ...
            <div className="mt-2 md:flex justify-between items-center text-gray-700">
