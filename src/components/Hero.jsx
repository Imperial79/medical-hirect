                ...
                <div className='border mt-10 bg-white rounded-tl-lg rounded-tr-lg p-10 md:w-[70%] w-[90%] mx-auto'>
                    <div className="flex flex-wrap sm:flex-nowrap">
                        ...
                        <div className="w-full sm:w-1/5">
                            <button type="button" class="w-full focus:outline-none text-center text-white bg-[#dc832d] hover:bg-yellow-500 focus:ring-2 focus:ring-yellow-300 font-medium md:rounded-tr-lg md:rounded-br-lg text-sm px-5 py-2.5 mr-2 mb-2 light:focus:ring-yellow-900">Search Jobs</button>
                        </div>
